...
fn move_chassis(_xrpm: f64, _yrpm: f64, _yaw: f64) {
    ...
    let rotation_component: f64 = _yaw * ROBOT_CENTER_TO_WHEEL_DISTANCE;
    ...
    move_wheel(front_left_direction, front_left_speed);
    move_wheel(front_right_direction, front_right_speed);
    move_wheel(rear_left_direction, rear_left_speed);
    move_wheel(rear_right_direction, rear_right_speed);
}

fn move_wheel(_wheel_direction: f64, _power: i64){
    //いい感じに制御しよう
